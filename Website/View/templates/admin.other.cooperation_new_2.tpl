		...
		{if $rs!=''}
            ...
            <div id="tabs-1">
                <form action="admin.other.php?type={$type}" method="post">
                    職務名稱:<input type="text" name="CONTENT_TITLE" value="{$field.CONTENT_TITLE}"/> <br/>
                    公司單位名稱:<input type="text" name="CONTENT_REMARK" value="{$field.CONTENT_REMARK}" /> <br/>
                    工作地點:<input type="text" name="CONTENT_TIME" value="{$field.CONTENT_TIME}" /> <br/>
                    公佈日期:<input type="text" name="CONTENT_DATE" value="{$field.CONTENT_DATE}" /> <br/>
