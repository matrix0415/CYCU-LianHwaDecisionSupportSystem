    	...
    	{if $rs!=''}
            ...
            <div id="tabs-1">
                <form action="admin.other.php?type={$type}" method="post">
                    案例名稱:<input type="text" name="CONTENT_TITLE" value="{$field.CONTENT_TITLE}"/> <br/>
                    合作企業:<input type="text" name="CONTENT_DATE" value="{$field.CONTENT_DATE}" /> <br/>
                    單位/系所:<input type="text" name="CONTENT_TIME" value="{$field.CONTENT_TIME}" /> <br/>
