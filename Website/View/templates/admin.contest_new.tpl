...
<div id="about_tabs">
	<ul>
    	...
    	{if $rs!=''}
            ...
            <div id="tabs-1">
                <form action="admin.contest.php?type={$type}" method="post">
                    競賽名稱:<input type="text" name="CONTENT_TITLE" value="{$field.CONTENT_TITLE}"/> <br/>
                    報名日期:<input type="text" name="CONTENT_DATE" value="{$field.CONTENT_DATE}"/> <br/>
