<?php /* Smarty version Smarty-3.1.8, created on 2012-11-01 19:55:39
         compiled from "/var/www/activity/ProgramFiles/View/templates/admin.contest_new.tpl" */ ?>
<?php /*%%SmartyHeaderCode:949822231508e21db7479d4-25258154%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '254d9a83d2f04364cf09134520e188650e8cfb15' => 
    array (
      0 => '/var/www/activity/ProgramFiles/View/templates/admin.contest_new.tpl',
      1 => 1351770934,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '949822231508e21db7479d4-25258154',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_508e21db83bc22_94706342',
  'variables' => 
  array (
    'site_root' => 0,
    'items' => 0,
...
<?php if ($_valid && !is_callable('content_508e21db83bc22_94706342')) {function content_508e21db83bc22_94706342($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("admin.head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
?>
            <div id="tabs-1">
                <form action="admin.contest.php?type=<?php echo $_smarty_tpl->tpl_vars['type']->value;?>
" method="post">
                    競賽名稱:<input type="text" name="CONTENT_TITLE" value="<?php echo $_smarty_tpl->tpl_vars['field']->value['CONTENT_TITLE'];?>
"/> <br/>
                    報名日期:<input type="text" name="CONTENT_DATE" value="<?php echo $_smarty_tpl->tpl_vars['field']->value['CONTENT_DATE'];?>
"/> <br/>
...
" />
        ...
        <?php }else{ ?>
            <div id="tabs-1">
                <form action="admin.contest.php?type=<?php echo $_smarty_tpl->tpl_vars['type']->value;?>
" method="post">
                    競賽名稱:<input type="text" name="CONTENT_TITLE" /> <br/>
                    報名日期:<input type="text" name="CONTENT_DATE" /> <br/>
